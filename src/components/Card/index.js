    ...
    <div className="max-w-sm bg-darkbg rounded-lg border border-gray-200 shadow-md">
      ...
      <div className="p-5">
        ...
        <div className="flex flex-row-reverse">
          <a href="#" className="inline-flex items-center py-2 px-3 text-sm font-medium text-center text-white bg-primary rounded-lg hover:bg-altprimary focus:ring-2 focus:outline-none focus:ring-lightblue">
            Read more
